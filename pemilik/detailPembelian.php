                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row row-deskripsi">
                                <div class="col-md-4">
                                    <h5>Pembelian</h5>
                                    <h6>No. Pembelian : <?php echo $detail['id_pembelian']; ?></h6>
                                    <p>
                                ...
                                <div class="col-md-4">
                                    <h5>Pelanggan</h5>
                                    <h6>Nama : <?php echo $detail['nama']; ?></h6>
                                    <p>
                                ...
                                <div class="col-md-4">
                                    <h5>Pengiriman</h5>
                                    <h6>Kurir : <?php echo $detail['jenis_kurir']; ?></h6>
                                    <p>
                                        ...
                                        <tbody class="table-group-divider align-middle">
                                            ...
                                            while ($pecah = $ambil->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-danger">Rp. <?php echo number_format($pecah["subharga"]); ?></td>
                                                </tr>
                                                <?php $nomor++; ?>
                                            <?php } ?>
                                        </tbody>
